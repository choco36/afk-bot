...
class BotManager {
  ...
  async start(cfg){
    ...
    const go=()=>{
      ...
      const bot=mineflayer.createBot({ host:cfg.host, port:Number(cfg.port||25565), auth:cfg.auth||'microsoft', username:cfg.auth==='offline'?(cfg.username||'Player'):undefined })
